...
export const REFUNDS_SERVICE = Symbol("REFUNDS_SERVICE");
export const REFUNDS_STORE = Symbol("REFUNDS_STORE");
export const REDIS_HEALTH = Symbol("REDIS_HEALTH");
export const SCANNING_SERVICE = Symbol("SCANNING_SERVICE");
export const SCANNING_STORE = Symbol("SCANNING_STORE");
export const STRUCTURED_LOGGER = Symbol("STRUCTURED_LOGGER");
export const TICKETS_SERVICE = Symbol("TICKETS_SERVICE");
export const TICKETS_STORE = Symbol("TICKETS_STORE");
